package co.xiaodao.weixin.json.weather;
...
public class WeatherJson {
	...
	public String toString() {
		...
		buffer.append("※※").append(city).append("天气预报※※").append("\n");
		buffer.append(WeatherUtil.getDateByDiff(date_y, +0)).append(" ")
				.append(temp1).append("\n");
		buffer.append(weather1).append("\n");
		buffer.append(wind1).append("\n").append("\n");
		buffer.append(WeatherUtil.getDateByDiff(date_y, +1)).append(" ")
				.append(temp2).append("\n");
		buffer.append(weather2).append("\n");
		buffer.append(wind2).append("\n").append("\n");
		buffer.append(WeatherUtil.getDateByDiff(date_y, +2)).append(" ")
				.append(temp3).append("\n");
		buffer.append(weather3).append("\n");
		buffer.append(wind3).append("\n").append("\n");
		buffer.append("穿衣指数：").append(index).append("\n");
		buffer.append(index_d).append("\n");
